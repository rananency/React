...
function Home() {
                ...
                <div className="table-data">
                    <div className="title">
                        ...
                        <div className="task-title1">
                            {
                                Moment(task1.dueDate).format('DD-MMM-YYYY')
                            }
                        </div>
                    </div>
    ...
    return (
        <div className="main">
            <div className="add-todo-header" style={Task.length == 0 ? { display: 'none' } : {}}>To-Do List</div>
            <div className="remove-all">
                <form>
                    <button
                        className="remove_btn" style={Task.length == 0 ? { display: 'none' } : {}}
                        type='submit' onClick={clear_all}>Clear List</button></form>
            </div>
